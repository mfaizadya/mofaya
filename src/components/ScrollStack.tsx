...
// Previous attempts broke it by caching positions and removing Lenis.
// The original reads live positions via getElementOffset on every frame — that's intentional.
